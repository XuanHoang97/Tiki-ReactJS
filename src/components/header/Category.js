...
export default function Category(props) {
  ...
  return (
    <li className="menu_ctg nav-item dropdown mr-2 active">
      <a
        className="category nav-link dropdown-toggle" href="/" id="dropdownId" data-toggle="dropdown" data-hover="dropdown" aria-haspopup="true" aria-expanded="false">
