                            ...
                            <div className="collapse navbar-collapse col-md-11 p-0" id="collapsibleNavId">
                                <ul className="navbar-nav align-items-center col-md-12">
                                    ...
                                    <Modal className="login_resg" show={this.state.showHide} size="lg" centered>
                                        <button className="close text-end" closeButton onClick={() => this.Modal()} style={{ textAlign: 'end', position: 'absolute', right: '-15px', zIndex: 10, background: 'white', top: '-15px', border: '1px solid', borderRadius: '50%', width: '30px', height: '30px', display: 'flex', justifyContent: 'center' }}>×</button>
